...
takes in Julian date data in the J2000 epoch or in another epoch with the
appropriate offset to convert to the J2000 epoch. Example usage of the `Time`
class to carry out conversions can be seen in the tutorials page
...
used to carry out coordinate transformations between differerent coordinate
...
capacity can be seen in the tutorials page
