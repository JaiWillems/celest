...
def precession_matrix(julian: Quantity) -> np.ndarray:
    ...
    a1 = zeta.to(u.rad).data / 3600
    a2 = theta.to(u.rad).data / 3600
    a3 = - z.to(u.rad).data / 3600
...
def nutation_matrix(julian: Quantity) -> np.ndarray:
    ...
    a1 = eps_A.to(u.rad).data / 3600
    a2 = - nutation_in_longitude.to(u.rad).data / 3600
    a3 = - eps_A.to(u.rad).data / 3600 + nutation_in_obliquity.to(u.rad).data / 3600
