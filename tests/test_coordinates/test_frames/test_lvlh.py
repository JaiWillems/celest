...
class TestLVLH(TestCase):
    ...
    def test_parent_class_is_initialized(self):
        ...
        self.assertTrue(np.array_equal(self.x, self.valid_lvlh.x.data))
        self.assertEqual(self.unit, self.valid_lvlh.x.unit)

        self.assertTrue(np.array_equal(self.y, self.valid_lvlh.y.data))
        self.assertEqual(self.unit, self.valid_lvlh.y.unit)

        self.assertTrue(np.array_equal(self.z, self.valid_lvlh.z.data))
