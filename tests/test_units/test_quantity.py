...
class TestQuantity(TestCase):
    ...
    def setUp(self):
        ...
        self.comparison_offset = 1  # Offset applied to values for comparison tests.
    ...
    def test_mul_quantity_of_different_dimensions(self):
        ...
        self.assertEqual(self.data * self.data, result.data)
        self.assertEqual(
            repr(self.simple_unit * self.compound_unit),
            repr(result.unit)
        )
    ...
    def test_truediv_quantity_of_same_dimensions(self):
        ...
        self.assertEqual(
            repr(self.simple_unit / self.simple_unit),
            repr(result.unit)
        )
    ...
    def test_rtruediv_quantity_of_different_dimensions(self):
        ...
        self.assertEqual(1, result.data)
        self.assertEqual(
            repr(self.compound_unit / self.simple_unit),
            repr(result.unit)
        )
    ...
    def test_eq_when_equal_with_same_units(self):
        self.assertTrue(self.simple_quantity == self.simple_quantity)

    def test_eq_when_not_equal_with_same_units(self):
    ...
    def test_neq_when_not_equal_with_same_units(self):
        self.assertTrue(self.simple_quantity != (self.simple_quantity + 1))

    def test_neq_when_equal_with_same_units(self):
    ...
    def test_lt_when_less_than_with_same_units(self):
        self.assertTrue(self.simple_quantity < (self.simple_quantity + 1))

    def test_lt_when_greater_than_with_same_units(self):
    ...
    def test_le_when_less_with_same_units(self):
        self.assertTrue(self.simple_quantity <= (self.simple_quantity + 1))

    def test_le_when_equal_with_same_units(self):
        self.assertTrue(self.simple_quantity <= self.simple_quantity)

    def test_le_when_greater_with_same_units(self):
    ...
    def test_ge_when_greater_with_same_units(self):
        self.assertTrue((self.simple_quantity + self.comparison_offset) >= self.simple_quantity)

    def test_ge_when_equal_with_same_units(self):
        self.assertTrue(self.simple_quantity >= self.simple_quantity)

    def test_ge_when_less_with_same_units(self):
        self.assertFalse(self.simple_quantity >= (self.simple_quantity + 1))

    def test_ge_with_different_dimensions_raises_arithmetic_error(self):
        self.assertRaises(
            ArithmeticError,
            self.simple_quantity.__ge__,
            self.compound_quantity
        )
    ...
    def test_dimension_property(self):
        self.assertEqual(
            self.simple_quantity.dimension,
    ...
    def test_convert_to_same_dimension(self):
        new_quantity = self.simple_quantity.convert_to(u.km)
    ...
    def test_convert_to_with_compound_unit(self):
        ...
        new_quantity = self.compound_quantity.convert_to(new_compound_unit)
